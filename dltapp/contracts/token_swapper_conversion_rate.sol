...
contract TokenSwapperWithConversionRate {
    ...
    function sellMMFTokenWithConversionRate(
        ...
        bool approvedA = IERC20(mmfToken).forceApprove(
            sender,
            address(this),
            amountA
        );
        ...
        bool approvedB = IERC20(cashToken).forceApprove(
            recipient,
            address(this),
            convertedAmountA
        );
        ...
        // success
        bool successA = IERC20(mmfToken).transferFrom(
            sender,
            recipient,
            amountA
        );
        ...
        bool successB = IERC20(cashToken).transferFrom(
            recipient,
            sender,
            convertedAmountA
        );
