...
import { getCurrentProfits } from '../../utils';
...
export default function ActionButtons() {
  ...
  const TABS = [
    ...
    },
    {
      ...
      isLoadingSelector: selectTransactionLoading,
      error: selectTransactionError,
      currentOperation: selectCurrentTransaction
    },
  ];
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      let payload = tabIdx == 2 ? { amount: readableProfits * 1000000000000000000 } : {
        to: formData.to,
        ...
        <form onSubmit={handleSubmit}>
          {tabIdx == 2 && (
            ...
            <div className='flex flex-col flex-wrap'>
              <p className="text-left"><label className="w-28 text-sm font-medium text-gray-700">Profits earned</label> {readableProfits}</p>
